...
<header><b>Magnet Climbers admin</b><input id="key" type="password" placeholder="ADMIN_KEY" style="flex:1;max-width:320px"><button class="ok" onclick="saveKey()">Use key</button><button onclick="load()">Refresh</button><a href="https://magnetclimbers.com/art-archive/" target="_blank" style="color:#7cc">Art archive</a><a href="https://magnetclimbers.com/elements/" target="_blank" style="color:#7cc">Element map</a><span id="status"></span></header>
<main>
