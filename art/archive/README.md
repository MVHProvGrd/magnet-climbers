...
|---|---|---|---|
| `18-extended-limbs-v1/` | Longer cat foreleg and boy teal sleeve, sources, cutouts and light/dark review. Camera-safe root/retraction handoff. | Codex built-in imagegen edits | LIVE: both in `real-v1/` (cat-paw.webp, kid-arm.webp); paw depth capped to the leg, sleeve/leg bands only repeat as a fallback |
