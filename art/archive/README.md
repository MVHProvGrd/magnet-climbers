...
|---|---|---|---|
| `17-cat-paw-claws-v2/` | Corrected furry BACK view with ivory claws; three-tap preview with fading scratches. Supersedes pack15 underside, which stays archived. | Codex built-in imagegen; isolated motion/effect review | LIVE: replaces pack 15 in `real-v1/cat-paw.webp`; claw marks fade on the door after each tap |
