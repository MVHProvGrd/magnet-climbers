# Art refresh handoff — log (superseded sections, newest first)

Moved VERBATIM out of `ART_REFRESH_HANDOFF.md` on 2026-09-17 so the live mailbox stays small.
Read on demand only. When you retire a section from the mailbox, prepend it here unchanged.
