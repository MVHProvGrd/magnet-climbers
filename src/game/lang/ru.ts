...
export const exact: Record<string, string> = {
  ...
  "🔴 The red line is Cooper's reach. It rises faster the higher you get. Keep moving.": "🔴 Красная линия — досягаемость ребёнка. Чем выше, тем быстрее она растёт. Не стойте.",
