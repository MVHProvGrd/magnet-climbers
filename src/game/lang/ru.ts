...
export const exact: Record<string, string> = {
  ...
  "Fling rubbery magnet toys up an endless fridge. Stick to steel. Outrun Cooper.": "Запускайте резиновые магнитики вверх по бесконечному холодильнику. Держитесь за сталь. Убегайте от ребёнка.",
  ...
  "Steel holds": "Стальные зацепы", "S souvenirs pull you in": "Сувениры S притягивают", "N souvenirs push you away": "Сувениры N отталкивают", "Glass": "Стекло", "Plastic": "Пластик", "Paper": "Бумага", "Open gaps": "Пустоты", "Keyrings swing": "Качающиеся брелоки", "Letters rotate": "Вращающиеся буквы", "Clips dangle": "Висячие зажимы", "Pole flippers": "Переключатели полюсов", "Advertising magnets": "Рекламные магниты", "Toy magnets": "Магниты-игрушки", "The kid": "Ребёнок", "Currency": "Валюта", "Hearts": "Сердца", "Boosts": "Усиления", "Drawings and notes": "Рисунки и записки", "Cut-outs": "Вырезки", "Prints": "Печатное", "More": "Ещё", "Centre Seam": "Центральный шов", "The groove between the two doors runs the whole way up. No grip in it; cross it in flight.": "Щель между дверями идёт до самого верха. Зацепиться не за что — перелетайте.", "Cooper's Hand": "Рука ребёнка", "A hand swipes across the door now and then. Watch for the LOOK OUT warning and get out of its curved path.": "Время от времени по двери проносится рука. Следите за предупреждением LOOK OUT и уходите с её дуги.",
  "Tahiti (S)": "Таити (S)", "Seychelles (S)": "Сейшелы (S)", "Cape Town (S)": "Кейптаун (S)", "Rio (S)": "Рио (S)", "Edinburgh (N)": "Эдинбург (N)", "Lapland (N)": "Лапландия (N)",
  ...
  "A toy. On a keychain it is plain resin and just swings when brushed; stuck straight on the door it is a magnet with a slight push. Never a grip.": "Игрушка. На брелоке это просто смола — качается, если задеть; прилепленная к двери — магнит с лёгким отталкиванием. Зацепиться нельзя.",
  ...
  "We are the magnet people. We hold up the pizza menu, the dentist card, the photo of Cooper. Good job. Steady work.": "Мы — магнитные человечки. Держим меню пиццы, карточку стоматолога, фото ребёнка. Хорошая работа. Стабильная.",
  "Then bedtime came": "А потом пришло время спать",
  "Cooper \"tidied up\". Now we are on the floor, and the sock drawer is next. Anyone still on the fridge by morning stays on the fridge.": "Ребёнок «прибрался». Теперь мы на полу, а дальше — ящик с носками. Кто к утру на холодильнике, тот на нём и останется.",
  "So we climb": "Значит, лезем",
  "Fling, stick, climb. Steel holds. Glass, plastic and stickers don't. The red line is Cooper's reach. Stay above it.": "Бросок, прилип, лезь. Сталь держит. Стекло, пластик и наклейки — нет. Красная линия — досягаемость ребёнка. Держитесь выше.",
  // board
  ...
  "🧲 You stick to bare steel only. Glass, paper and plastic slide you straight off.": "🧲 Держишься только на голой стали. Стекло, бумага и пластик — сразу вниз.",
  "🟡 Grab coins on the way up. They buy a higher jump before your next climb.": "🟡 Собирай монеты по пути наверх. На них берут прыжок повыше перед следующим подъёмом.",
  "🔴 The red line is Cooper's reach. It speeds up the higher you get, so never stop climbing.": "🔴 Красная линия — это рука мальчика. Чем выше, тем быстрее она идёт, так что не стой.",
  "✅ That's it. When a hand lights up its path, fling clear of it. Go climb.": "✅ Вот и всё. Когда рука подсветит свой путь, улетай с него. Вперёд.",
  // HUD (canvas)
...
export const rules: Rule[] = [
  [/^(.+) · shown in chat$/, (m) => `${t(m[1])} · виден в чате`],
  [/^You are (.+)$/, (m) => `Вы — ${m[1]}`],
