...
export const PATTERNS: PatternDef[] = [
  ...
  { id: "seaside", name: "Beach House", rarity: "epic", limited: "seaside", colors: ["#57c8e0", "#2fb2cd", "#8addf0", "#1b9bb5", "#72d3e7", "#b6ecf6"] },
  { id: "picnic", name: "Backyard Picnic", rarity: "epic", limited: "picnic", colors: ["#e06a5a", "#c74f40", "#ef9184", "#ad3a2d", "#e87d6d", "#f7b8ae"] },
  { id: "sunblock", name: "Popsicle", rarity: "epic", limited: "sunblock", colors: ["#ff8a5c", "#ff6f3c", "#ffab85", "#f2551f", "#ff9a70", "#ffc8ae"] },
  { id: "pencil", name: "Back to School", rarity: "epic", limited: "pencil", colors: ["#ffc93f", "#f0b31f", "#ffd970", "#d99a10", "#ffd156", "#ffe9a8"] },
